    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-black p-6'>
            <div className='flex items-center flex-shrink-0 text-white mr-6'>
                <Link to='/' className='font-semibold text-xl tracking-tight'>Car App</Link>
            </div>
            <div className='block'>
                <button onClick={dropDown} className='flex items-center px-3 py-2 bg-white border rounded border-white hover:text-white hover:border-white'>
            ...
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    ...
                    </Button>
                    {
                        ...
                        <Button className='p-3 m-5 bg-black justify-center'>
                            <div>
                                <Link to='/' onClick={ () => {signInOnClick()}} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                                 text-teal-200 hover:text-white mr-4'>
                                    Sign In
                                </Link>
                            </div>
                        ...
                        <Button className='p-3 m-5 bg-black justify-center'>
                            <div>
                                <Link to='/' onClick={ () => {signOutOnClick()}} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                                 text-teal-200 hover:text-white mr-4'>
                                    Sign Out
                                </Link>
                            </div>
